  ...
  <div class="app-container">
    <el-row>
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header><Cpu style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">{{ $t('CPU') }}</span></template>
            ...
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  ...
                  <th class="el-table__cell is-leaf"><div class="cell">{{ $t('JVM') }}</div></th>
                </tr>
              </thead>
              <tbody>
                <tr>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><CoffeeCup style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">{{ $t('Java虚拟机信息') }}</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('Java名称')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="server.jvm">{{ server.jvm.name }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('Java版本')}}</div></td>
                ...
                <tr>
                  <td colspan="1" class="el-table__cell is-leaf"><div class="cell">{{$t('运行参数')}}</div></td>
            ...
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  ...
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('盘符类型')}}</div></th>
...
function getList() {
  proxy.$modal.loading(t('正在加载服务监控数据，请稍候！'));
