...
const canvasWidth =
  Math.floor(window.innerWidth * 0.15) < 360
    ? 360
    : Math.floor(window.innerWidth * 0.15); // 基准宽度
const canvasHeight = window.innerHeight * 0.65; // 基准高度
console.log("canvasWidth", canvasWidth);
console.log("canvasHeight", canvasHeight);

// 分辨率
// let resolution = "1080*2340";
...
// if (resolution) {
//   [originalWidth, originalHeight] = resolution.split("*").map(Number);
// }
