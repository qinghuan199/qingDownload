<template>
	<view class="page">
		<image src="@/static/pea/bg.png" class="bg-img" mode="aspectFill" />
			<view class="content">
				<!-- 		<view class="">
					<view class="">
					</view>
				...
				<view class="logo">
					<image src="/static/pea/logo.png" mode="widthFix" class="logo"></image>
				</view>
				...
				http.post('/OnlineDevice/login', data)
					.then((response) => {
						...
						if (loginResponse.code == 200) {
							...
							setTimeout(() => {
								uni.reLaunch({
									url: "/pages/setting/setting" // 登录成功后跳转到首页
								});
							}, 2000);
...
<style scoped lang="scss">
	// page {
	// 	height: 100vh;
	// 	background-image: url('/static/pea/bg.png');
