<template>
	<view class="content">
		<image @click="goback" class="back" src="/static/mea/back.png"></image>
		<view class="text-area">
			<text class="title">{{$t('setting.text')}}</text>
			<image @click="change" class="btn" :src="show==true?'/static/mea/btn1.png':'/static/mea/btn2.png'"></image>
		</view>
...
<style>
	...
	.back {
		width: 80rpx;
		height: 80rpx;
		margin: 80rpx 50rpx 80rpx 40rpx;
	}
</style>