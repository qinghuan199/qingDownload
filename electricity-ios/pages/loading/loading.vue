<template>
	<view class="content">
		<image class="logo" src="/static/mea/logo-1.png"></image>
		<image class="image" src="/static/mea/1.png"></image>

	<!-- 	<view v-if="isShow" @click="onLogin" class="login-btn">
			{{$t('index.login')}}
		</view> -->
...
<script>
	export default {
		...
		methods: {
			...
			// 启动进度条，10分钟到100%
			startProgress() {
				const duration = 10 * 60 * 100000; // 10分钟转换为毫秒
